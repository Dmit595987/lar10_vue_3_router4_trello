                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="form-check form-switch form-check-reverse" v-for="task in current_cards.tasks">
                                                    <input class="form-check-input" @change="click_checkbox(task.id, current_cards.id)" type="checkbox" id="flexSwitchCheckReverse">

                                                    <form action="#" v-if="show_task_name === task.id">
                                                        <input @blur="edit_task_name(task.id, task.name)"
                                                                type="text" v-model="task.name" class="form-control">
                                                    </form>
                                                    ...
                                                    <a href="#" v-if="show_task_name !== task.id" @click.prevent="deleteTask(task.id, current_cards.id)">
                                            ...
                                            <div class="modal-footer">
                                                <button type="button" @click.prevent="show_task_name = false" class="btn btn-secondary" data-bs-dismiss="modal">
                                                    Close
                                                </button>
                                                <button type="button"  @click.prevent="show_task_name = false" class="btn btn-primary">Save changes</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
export default defineComponent({
    ...
    methods: {
        ...
        click_checkbox(task_id, card_id){
            this.deleteTask(task_id, card_id)
        },
        ...
        edit_task_name(task_id, task_name){
            ...
            axios.patch('/api/tasks/' + task_id, {name: task_name})
                .then(res => {
